...
\begin{itemize}
    ...
    \ides{Third Normal Form (3NF)}
        \begin{itemize}
            ...
            \ides{Recipe:} Decompose $\mc{R}$ into $\mc{R}_1, \dots, \mc{R}_n$ according to 3NF
                \begin{itemize}
                ...
                \end{itemize} \todo{Improve recipe}
        \end{itemize}
    \ides{Boyce-Cod Normal Form (BCNF)}
        \begin{itemize}
            ...
            \icon Does not get rid of all data redundancies
                ...
                \end{itemize}
            \ides{Recipe:} Decompose $\mc{R}$ into $\mc{R}_1, \dots, \mc{R}_n$ according to BCNF
                \begin{itemize}
        ...
        \begin{itemize}
            \ides{Multi-Value Dependency (MVD)}
                \begin{itemize}
                    ...
                    \ides{Multi-Value Augmentation:} $\alpha \to \to \beta \wedge (\delta \subset \gamma) \implies \alpha \gamma \to \to \beta \delta$
            ...
            \ides{Recipe:} Decompose $\mc{R}$ into $\mc{R}_1, \dots, \mc{R}_n$ according to 4NF
                \begin{itemize}
                    \item[1)] Set result to $\{\mc{R}\}$
                    \item[2)] If there is $\mc{R}_i = \alpha \to \beta$ which is not in BCNF
                        \begin{itemize}
                        ...
                        \end{itemize}
                    \item[3)] Repeat $2$ as long as there are $\mc{R}_i$ which are not in BCNF
                \end{itemize} \todo{Improve recipe} \todo{Why same as for 3NF?}
        \end{itemize}
