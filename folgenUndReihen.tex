...
\begin{tabular}{l | l | c | c | c}
    ...
    $\sum_{k=1}^{\infty} (k+1)q^k$ & $1 + 2q +$ & $\frac{1}{(1-q)^2}$ &&\\\hline
    ...
    $\sum_{k=1}^{\infty} \frac{(-1)^k}{2k + 1}$ & $1 - \frac{1}{3} + \frac{1}{5} -$ & $\frac{\pi}{4}$ &&\\\hline
    ...
    $\sum_{k=1}^{\infty} \frac{z^k}{k!}$ & $1 + z + \frac{z^2}{2!} +$ & $\exp{z}$ &&\\\hline
    $\sum_{k=1}^{\infty} \frac{(-1)^k}{k!}$ && $\frac{1}{e}$ &&\\\hline
\end{tabular}
