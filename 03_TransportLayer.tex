...
\end{verbatim}
    ...
    \ides{Flow Control}
        \begin{itemize}
            \ides{Sliding Window:} Restrict to sender and receiver buffer to a certain size
        ...
        \begin{itemize}
            ...
            \ides{Duplication:}
                \begin{itemize}
                    ...
                    \todo{So why does it even cause duplicate ACKs?}
...
\begin{itemize}
    ...
    \item
        \begin{tabular}{p{0.3 \textwidth} | p{0.3 \textwidth} | c}
            Property & TCP & UDP\\
            \hline
...
\begin{itemize}
    \ides{User Datagram Protocol (UDP)}
...
\begin{itemize}
    \ides{Transmission Control Protocol (TCP)}
    ...
    \ides{React to Congestion}
        \begin{itemize}
            ...
            \ides{Fairness}
                ...
                \end{itemize}
            \ides{Additive Increase Multiplicative Decrease}
                \begin{itemize}
                ...
                \begin{itemize}
                    ...
                    \ides{Fast Recovery}
                        \begin{itemize}
                            ...
                            \item Try to react before network gets congested
                            \item Switch to AIMD after fast retransmit 
                        \end{itemize}
                    \item Full code:
\begin{verbatim}
Initially:
